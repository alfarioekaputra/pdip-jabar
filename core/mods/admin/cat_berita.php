...
define('_MODULE_TITLE', "Kategori Berita");
define('_TABLE_NAME',   _dbp."_berita_cat");
...
<div class="row">
  ...
  <div class="vals">
    <input type="radio" name="portrait" value="0" <?php echo ($row['portrait']?'':'checked="checked" '); ?>/> Landscape
    <input type="radio" name="portrait" value="1" <?php echo ($row['portrait']?'checked="checked" ':''); ?>/> Portrait
  </div>
</div>
<div class="row">
  <div class="label">
...
function do_list(){
  ...
  if (!$num){
    ...
    for ($i=0;$i<count($rows);$i++){
      ...
      echo "<td align=\"center\">".($row['portrait']?'Portrait':'Landscape')."</td>";
      echo '</tr>';
    }
