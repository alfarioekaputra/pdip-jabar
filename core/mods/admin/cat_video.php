...
define('_MODULE_TITLE', "Kategori Video");
define('_TABLE_NAME',   _dbp."_video_cat");
...
function do_edit(){
  ...
  //-- Get Error Insert
    ...
    echo '<b>Tips:</b> <u>Kode</u> harus di isi dengan kode yang unik dan belum digunakan pada kategori video lain.</div>';
  }
